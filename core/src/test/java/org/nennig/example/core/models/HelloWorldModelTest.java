 ...
 */
package org.nennig.example.core.models;
...
import org.nennig.example.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "page-prop-example/components/helloworld");
